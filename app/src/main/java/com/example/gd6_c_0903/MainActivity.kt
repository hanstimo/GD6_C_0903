package com.example.gd6_c_0903
...
class MainActivity : AppCompatActivity() {
    ...
    private val CHANNEL_ID_2 = "channerl_notification_02"
    ...
    private fun sendNotification2() {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID_1)
            ...
            .setContentTitle(binding?.etTitle?.text.toString())
            .setContentText(binding?.etMessage?.text.toString())
            .setPriority(NotificationCompat.PRIORITY_LOW) // untuk menentukan posisi notif dimana
